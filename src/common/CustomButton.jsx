...
const CustomButton = ({ text, myClass, textTwo }) => {
  return (
    ...
    >
      <span className="absolute top-1/2 left-0 -translate-y-1/2 text-center w-full group-hover:-top-full duration-500 ease-linear">
        {text}
      </span>
      <span className="absolute -bottom-full left-0 translate-y-1/2 text-center w-full group-hover:bottom-1/2 duration-500 ease-linear">
        {textTwo}
      </span>
    </button>
  );
