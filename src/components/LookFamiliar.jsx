...
const LookFamiliar = () => {
  return (
    <div
      id="roadmap"
      className="min-h-[1105px] bg-[url(/assets/images/familier-bg.webp)] bg-cover bg-bottom bg-no-repeat flex items-center justify-end pb-[158.8px] flex-col max-lg:pb-[148px] max-md:justify-center max-lg:min-h-screen max-md:pb-[68px] overflow-hidden max-w-[1920px] mx-auto"
    >
